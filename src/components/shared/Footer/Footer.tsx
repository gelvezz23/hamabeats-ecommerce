...
export const Footer = () => {
  return (
    <footer className={styles.footer}>
      <a
        href="https://www.instagram.com/hamabeadsbymg/"
        target="_blank"
        rel="noopener noreferrer"
        className={styles.instagramLink} // Opcional: Agrega una clase para estilos
      >
        <p>@hamabeadsbymg</p>
      ...
      <div className={styles.copyright}>
        <a
          href="https://github.com/gelvezz23" // Reemplaza con tu usuario de GitHub
          target="_blank"
          rel="noopener noreferrer"
